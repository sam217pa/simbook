...
There is a potential source of confusion here. The `edge` objects represent the "work" done by *nodes* on a tree--they tell us what lines to draw between which nodes.  The node table is largely just a record of their birth times as well as some additional data (population labels, etc.).
